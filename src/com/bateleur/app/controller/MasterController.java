	...
	public class PlaybackColorAnimation {
		...
		public PlaybackColorAnimation() {
			...
			playback.onSongChangeEvent.addListener(() -> {
				...
				Vector3D cBG_VEC = library.getByReference(playback.getLoadedAudio()).get(settings.AUDIO_META_COLR_BG);
				Vector3D cFG_VEC = library.getByReference(playback.getLoadedAudio()).get(settings.AUDIO_META_COLR_FG);
